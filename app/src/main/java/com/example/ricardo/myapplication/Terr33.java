...
public class Terr33 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terr33);
        ...
        String Hasta = getIntent().getStringExtra("TTRES");
    ...
    public void onClick(View view) {
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
            ...
            SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 33", nombre, manufacturer);
            sm.execute();
        }
        else{

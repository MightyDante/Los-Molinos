...
public class punto5 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng familia = new LatLng(-33.352383, -70.744680);
        ...
        mmMap.addMarker(new MarkerOptions()
                .position(familia)
                .title("Punto 5")
                .snippet("Kilimanjaro / Estacion Til-Til")

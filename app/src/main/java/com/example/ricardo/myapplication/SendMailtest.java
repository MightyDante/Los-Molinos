...
public class SendMailtest extends AsyncTask<Void,Void,Void> {
    ...
    //Class Constructor
    public SendMailtest(Context context, String fecha, String manzanas, String horario, String territorio, String nombre, String id){
    ...
    private final Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            if(msg.arg1 == 2) {
                ...
                builder.setMessage("¡Su registro se a enviado con exito!");

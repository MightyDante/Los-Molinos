...
public class Terr5 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terr5);
    ...
    public void onClick(View view) {
        ...
        if(estado2 == true)
            ...
            builder.setMessage("¿Le gustaria guardar este Nombre com predeterminado?");
            builder.setPositiveButton("Si",new DialogInterface.OnClickListener()
            {
                ...
                public void onClick(DialogInterface dialog, int which)
                {
                        ...
                        Intent conf = new Intent(Terr5.this, Configuracion.class);
                        startActivity(conf);
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
            ...
            SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 5", nombre, manufacturer);
            sm.execute();
        }
        else{

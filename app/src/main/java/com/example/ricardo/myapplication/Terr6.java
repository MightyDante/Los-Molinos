...
public class Terr6 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terr6);

        TableRow = (ImageView) findViewById(R.id.img);
        Nombre2 = (EditText) findViewById(R.id.Nombre4);
        ...
        String Hasta = getIntent().getStringExtra("SEIS");
        Nombre2.setText(Hasta + "");
        SharedPreferences preferencias = getSharedPreferences("HOLAA", Context.MODE_PRIVATE);
        Nombre2.setText(preferencias.getString("lol", ""));
    ...
    public void onClick(View view) {
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
            ...
            SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 6", nombre, manufacturer);
            sm.execute();
        }
        else{

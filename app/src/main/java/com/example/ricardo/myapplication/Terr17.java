...
public class Terr17 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terr17);
        Nombre = (EditText) findViewById(R.id.Nombre);

        TableRow = (ImageView) findViewById(R.id.img);
        String Hasta = getIntent().getStringExtra("DSIETE");
    ...
    public void onClick(View view) {
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
            ...
            SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 17", nombre, manufacturer);
            sm.execute();
        }
        else{

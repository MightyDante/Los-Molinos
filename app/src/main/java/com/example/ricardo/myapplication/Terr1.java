...
public class Terr1 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    Switch horario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terr1);
        TableRow = findViewById(R.id.img);
        Nombre = findViewById(R.id.Nombre);
        String Hasta = getIntent().getStringExtra("UNO");
    ...
    public void onClick(View view) {
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
                ...
                SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 1", nombre, manufacturer);
                sm.execute();

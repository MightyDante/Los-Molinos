...
public class Terr8 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terr8);
        TableRow = (ImageView) findViewById(R.id.img);
        Nombre = (EditText) findViewById(R.id.Nombre);

        String Hasta = getIntent().getStringExtra("OCHO");
    ...
    public void onClick(View view) {
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
            ...
            SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 8", nombre, manufacturer);
            sm.execute();
        }
        else{

...
public class punto3 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng familia = new LatLng(-33.355553, -70.740522);
        ...
        mmMap.addMarker(new MarkerOptions()
                .position(familia)
                .title("Punto 3")
                .snippet("Rigoberto Jara / José Miguel Neira")

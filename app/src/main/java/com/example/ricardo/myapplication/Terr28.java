...
public class Terr28 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terr28);
        TableRow = findViewById(R.id.img);
        Nombre = findViewById(R.id.Nombre);
        String Hasta = getIntent().getStringExtra("VOCHO");
    ...
    public void onClick(View view) {
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
            ...
            SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 28", nombre, manufacturer);
            sm.execute();
        }
        else{

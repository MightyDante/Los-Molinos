...
public class Terr7 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    ...
    public void onClick(View view) {
        ...
        if(estado2 == true) chk2 = (CheckBox)findViewById(R.id.manzana3);
        estado2 = chk2.isChecked();
        if(estado2 == true)
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
            ...
            SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 7", nombre, manufacturer);
            sm.execute();
        }
        else{

...
public class Terr34 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terr34);
        ...
        String Hasta = getIntent().getStringExtra("TCUATRO");
    ...
    public void onToogle(View view) {
        ...
        CheckBox chk7 = (CheckBox)findViewById(R.id.manzana7);
        chk7.setChecked(estado);
        CheckBox chk8 = (CheckBox)findViewById(R.id.manzana8);
        chk8.setChecked(estado);
        CheckBox chk9 = (CheckBox)findViewById(R.id.manzana9);
        chk9.setChecked(estado);
    }
    ...
    public void onClick(View view) {
        ...
        if(estado == true)
            manzanas = manzanas+"6,";
        chk = (CheckBox)findViewById(R.id.manzana7);
        estado = chk.isChecked();
        if(estado == true)
            manzanas = manzanas+"7,";
        chk = (CheckBox)findViewById(R.id.manzana8);
        estado = chk.isChecked();
        if(estado == true)
            manzanas = manzanas+"8,";
        chk = (CheckBox)findViewById(R.id.manzana9);
        estado = chk.isChecked();
        if(estado == true)
            manzanas = manzanas+"9,";
        ...
        estado2 = chk2.isChecked();
        if(estado2 == true)
            chk2 = (CheckBox)findViewById(R.id.manzana7);
        estado2 = chk2.isChecked();
        if(estado2 == true)
            chk2 = (CheckBox)findViewById(R.id.manzana8);
        estado2 = chk2.isChecked();
        if(estado2 == true)
            chk2 = (CheckBox)findViewById(R.id.manzana9);
        estado2 = chk2.isChecked();
        if(estado2 == true)
            if(estado2 == true)
                manzanas = "Completo ";
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
            ...
            SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 34", nombre, manufacturer);
            sm.execute();
        }
        else{

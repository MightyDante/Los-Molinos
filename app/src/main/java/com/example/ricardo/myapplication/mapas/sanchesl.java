...
public class sanchesl extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng familia = new LatLng(-33.352918, -70.745270);
        ...
        mmMap.moveCamera(CameraUpdateFactory.newLatLngZoom(familia, 15));
        mmMap.isMyLocationEnabled();

        mmMap.addMarker(new MarkerOptions()
                .position(familia)
                .title("Familia Sánches Linqueo")
                .snippet("Estación Batuco")
                .icon(BitmapDescriptorFactory.fromResource(R.mipmap.puntocasahmnos)));

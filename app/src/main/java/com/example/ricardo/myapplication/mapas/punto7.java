...
public class punto7 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng familia = new LatLng(-33.360052, -70.745237);
        ...
        mmMap.addMarker(new MarkerOptions()
                .position(familia)
                .title("Punto 7")
                .snippet("Lo Marcoleta alt. 361 (Supermercado)")
                .icon(BitmapDescriptorFactory.fromResource(R.mipmap.puntocarrito)));

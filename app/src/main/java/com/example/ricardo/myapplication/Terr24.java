...
public class Terr24 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terr24);
        TableRow = findViewById(R.id.img);
        Nombre = findViewById(R.id.Nombre);
        photoViewAttacher = new PhotoViewAttacher(TableRow);
        String Hasta = getIntent().getStringExtra("VCUATRO");
    ...
    public void onClick(View view) {
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
            ...
            SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 24", nombre, manufacturer);
            sm.execute();
        }
        else{

...
public class Terr20 extends AppCompatActivity implements View.OnClickListener {
    ImageView TableRow;
    ...
    public void onClick(View view) {
        ...
        if(!Objects.equals(manzanas, "") && !Objects.equals(fecha, "") && !Objects.equals(nombre, "")) {
            ...
            SendMailtest sm = new SendMailtest(this, fecha, manzanas, horario, "Territorio 20", nombre, manufacturer);
            sm.execute();
        }
        else{
